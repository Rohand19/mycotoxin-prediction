...
class ModelInterpreter:
    ...
    def plot_feature_importance(self, shap_values: np.ndarray, feature_names: List[str] = None) -> None:
        """
    ...
    def _get_top_features(self, shap_values: np.ndarray, top_n: int = 10) -> Dict[int, float]:
        """

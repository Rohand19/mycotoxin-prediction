    ...
    def plot_spectral_curves(self, data, wavelengths=None, save_path=None):
        ...
        try:
            ...
            if numeric_data.empty:
                ...
                ax.text(0.5, 0.5, "No numeric data available for plotting spectral curves", 
            ...
            # Plot the mean curve
            plt.plot(wavelengths[:len(mean_values)], mean_values, 'b-', label='Mean Spectrum')
            ...
            for i in range(num_samples):
                ...
                plt.plot(wavelengths[:len(sample_values)], sample_values, 'k-', alpha=0.1)
    ...
    def check_data_quality(self, data):
        ...
        try:
            ...
            quality_metrics = {
                ...
                'missing_percentage': (numeric_data.isnull().sum().sum() / 
                                    (numeric_data.shape[0] * numeric_data.shape[1]) * 100),
            ...
            outliers = ((numeric_data < (Q1 - 1.5 * IQR)) | 
                       (numeric_data > (Q3 + 1.5 * IQR))).sum().sum()
    ...
    def plot_quality_summary(self, data, save_path=None):
        ...
        try:
            ...
            if numeric_data.empty:
                ...
                # Create a simple figure with a text message
                fig, ax = plt.subplots(figsize=(10, 6))
                ax.text(0.5, 0.5, "No numeric data available for plotting", 
                       horizontalalignment='center', verticalalignment='center',
                       transform=ax.transAxes, fontsize=14)
                ax.axis('off')
                return
            ...
            melted_data = pd.melt(plot_data.reset_index(), id_vars=['index'], 
            ...
            sns.heatmap(corr_data, ax=ax4, cmap='coolwarm', annot=False, 
